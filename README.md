...
current scheme is Ether and all its layer-2 relatives charge 0.001 ($3); the cheapest option is Matic, charge 0.01 (¢1); all of them will go into 🐷(ω)'s pocket without any commitment; fatfat💰;
...
*side
- Polygon (id: `137`; compiler: `^0.8.25`) [contract address](https://polygonscan.com/address/0x73AEda68A10b8917C08060938Ae7274BEDAFD78e) *don't get it from opensea; is fake💩 (someone/bot there; copy your project name and suddenly replace your original one; insane💩; cheapest attack; seems the trick is reporting your project as spam then creating another one with the same name💩; understandable)
